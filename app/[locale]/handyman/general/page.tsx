...
const services: Service[] = [
  ...
  {
    "id": "furniture-assembly-gen",
    "name": "Furniture Assembly",
    "description": "Assemble any furniture",
    "price": 100,
    "duration": "1-2 hours"
  },
  {
    "id": "tv-mounting-gen",
    "name": "TV Mounting",
    "description": "Mount TVs on walls",
    "price": 120,
    "duration": "1 hour"
  },
  {
    "id": "picture-hanging",
    "name": "Picture & Shelf Hanging",
    "description": "Hang pictures and shelves",
    "price": 60,
    "duration": "30 min - 1 hour"
  },
  {
    "id": "minor-fixes",
    "name": "Minor Fixes & Adjustments",
    "description": "Small repairs and adjustments",
    "price": 80,
    "duration": "30 min - 1 hour"
  },
  {
    ...
    "description": "Hire handyman for various tasks",
    "price": 100,
    "duration": "Per hour"
  }
];
...
export default function GeneralHandymanPage() {
  ...
  const proceedToBooking = () => {
    ...
    sessionStorage.setItem('handymanCategory', 'general');
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="bg-gradient-to-r from-violet-500 to-purple-600 text-white py-12 px-4">
        <div className="container mx-auto max-w-7xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🔨 General Handyman Services</h1>
          <p className="text-xl opacity-90">Professional general handyman services in Dubai</p>
        </div>
      </div>
