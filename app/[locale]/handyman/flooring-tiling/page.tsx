...
const services: Service[] = [
  ...
  },
  {
    ...
    "description": "Fix broken tiles and regrout",
    "price": 150,
    "duration": "2-3 hours"
  },
  {
    ...
    "description": "Install laminate, vinyl, or wood flooring",
    "price": 400,
    "duration": "1-2 days"
  },
  {
    "id": "tile-cleaning",
    "name": "Tile Deep Cleaning",
    "description": "Deep clean and restore tiles",
    "price": 120,
    "duration": "2-3 hours"
  },
  {
    ...
    "description": "Polish and shine floors",
    "price": 180,
    "duration": "2-4 hours"
  }
];

export default function FlooringTilingPage() {
  ...
  const proceedToBooking = () => {
    ...
    sessionStorage.setItem('handymanCategory', 'flooring-tiling');
    router.push('/en/handyman/booking');
  };

  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="bg-gradient-to-r from-stone-500 to-slate-600 text-white py-12 px-4">
        <div className="container mx-auto max-w-7xl">
          <button onClick={() => router.push('/en/handyman')} className="text-white/80 hover:text-white mb-4">← Back</button>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🧱 Flooring & Tiling Services</h1>
          <p className="text-xl opacity-90">Professional flooring & tiling services in Dubai</p>
        </div>
      </div>
