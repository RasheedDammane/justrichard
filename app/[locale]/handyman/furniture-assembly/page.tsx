...
const services: Service[] = [
  ...
  },
  {
    "id": "tv-mounting",
    "name": "TV Mounting",
    "description": "Mount TV on wall securely",
    "price": 120,
    "duration": "1 hour"
  },
  {
    "id": "shelf-hanging",
    "name": "Shelf Hanging",
    "description": "Hang shelves and brackets",
    "price": 80,
  ...
  },
  {
    "id": "bed-assembly",
    "name": "Bed Assembly",
    "description": "Assemble bed frames",
    "price": 120,
    "duration": "1-2 hours"
  },
  {
    "id": "desk-assembly",
    "name": "Desk Assembly",
    "description": "Assemble office desks",
    "price": 100,
    "duration": "1 hour"
  },
  {
    ...
    "description": "Assemble large wardrobes",
    "price": 150,
    "duration": "2-3 hours"
  },
  {
    ...
    "description": "Install curtains and blinds",
    "price": 90,
    "duration": "1 hour"
  }
];
...
export default function FurnitureAssemblyPage() {
  ...
  const proceedToBooking = () => {
    ...
    sessionStorage.setItem('handymanCategory', 'furniture-assembly');
    router.push('/en/handyman/booking');
  };

  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-12 px-4">
        <div className="container mx-auto max-w-7xl">
          <button onClick={() => router.push('/en/handyman')} className="text-white/80 hover:text-white mb-4">← Back</button>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🔧 Furniture Assembly Services</h1>
          <p className="text-xl opacity-90">Professional furniture assembly services in Dubai</p>
        </div>
      </div>
