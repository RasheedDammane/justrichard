...
const services: Service[] = [
  ...
  },
  {
    ...
    "description": "Small touch-ups and repairs",
    "price": 100,
    "duration": "1-2 hours"
  },
  {
  ...
  },
  {
    ...
    "description": "Remove old wallpaper",
    "price": 180,
    "duration": "2-3 hours"
  },
  {
    ...
    "description": "Fix cracks and holes in walls",
    "price": 120,
    "duration": "1-2 hours"
  },
  {
    "id": "plastering",
    "name": "Plastering and Smoothing",
    "description": "Plaster and smooth wall surfaces",
    "price": 200,
    "duration": "2-4 hours"
  }
];
...
export default function PaintingPage() {
  ...
  const proceedToBooking = () => {
    ...
    sessionStorage.setItem('handymanCategory', 'painting');
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="bg-gradient-to-r from-pink-500 to-rose-500 text-white py-12 px-4">
        <div className="container mx-auto max-w-7xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🎨 Painting Services</h1>
          <p className="text-xl opacity-90">Professional painting services in Dubai</p>
        </div>
      </div>
