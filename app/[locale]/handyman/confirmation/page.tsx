export default function HandymanConfirmationPage() {
  return (
      ...
      <div className="max-w-2xl w-full">
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Thank you for choosing our handyman services
          </p>

          <div className="bg-orange-50 border-2 border-orange-200 rounded-xl p-6 mb-8">
            <h2 className="font-bold text-lg mb-3 text-orange-900">What happens next?</h2>
            <div className="space-y-3 text-left">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700">You'll receive a confirmation email with booking details</p>
              </div>
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700">Our team will call you to confirm the appointment</p>
              </div>
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700">A professional handyman will arrive at the scheduled time</p>
              </div>
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700">Work will be completed with quality guarantee</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="font-semibold">On-time arrival</p>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center text-sm">
              <a href="tel:+971XXXXXXXX" className="text-orange-600 hover:underline font-semibold">
                📞 +971 XX XXX XXXX
              </a>
              <a href="mailto:support@justrichard.com" className="text-orange-600 hover:underline font-semibold">
                ✉️ support@justrichard.com
              </a>
              <a href="https://wa.me/971XXXXXXXX" className="text-orange-600 hover:underline font-semibold">
                💬 WhatsApp Us
              </a>
            </div>
          </div>
