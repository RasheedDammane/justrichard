...
const services: Service[] = [
  ...
  },
  {
    ...
    "description": "Fix doors, frames, and hinges",
    "price": 150,
    "duration": "1-2 hours"
  },
  {
  ...
  },
  {
    ...
    "description": "Fix wardrobe doors and shelves",
    "price": 180,
    "duration": "1-2 hours"
  },
  {
    ...
    "description": "Repair damaged wood flooring",
    "price": 250,
    "duration": "2-3 hours"
  },
  {
  ...
  },
  {
    "id": "deck-repair",
    "name": "Deck Repair",
    "description": "Fix outdoor deck and railings",
    "price": 400,
    "duration": "3-5 hours"
  },
  {
...
export default function CarpentryPage() {
  ...
  const proceedToBooking = () => {
    ...
    sessionStorage.setItem('handymanCategory', 'carpentry');
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="bg-gradient-to-r from-amber-600 to-orange-600 text-white py-12 px-4">
        <div className="container mx-auto max-w-7xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🪚 Carpentry Services</h1>
          <p className="text-xl opacity-90">Professional carpentry services in Dubai</p>
        </div>
      </div>
