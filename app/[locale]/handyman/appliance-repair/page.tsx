...
const services: Service[] = [
  ...
  },
  {
    ...
    "description": "Repair fridge cooling problems",
    "price": 200,
    "duration": "1-2 hours"
  },
  {
    ...
    "description": "Fix microwave heating issues",
    "price": 120,
    "duration": "1 hour"
  },
  {
    ...
    "description": "Repair cooking appliances",
    "price": 180,
    "duration": "1-2 hours"
  },
  {
    ...
    "description": "Fix dishwasher leaks and issues",
    "price": 160,
    "duration": "1-2 hours"
  },
  {
    ...
    "description": "Repair water pump systems",
    "price": 200,
    "duration": "1-2 hours"
  },
  {
    "id": "dryer",
    "name": "Dryer Repair",
    "description": "Fix dryer heating and drum issues",
    "price": 170,
    "duration": "1-2 hours"
  }
];
...
export default function ApplianceRepairPage() {
  ...
  const proceedToBooking = () => {
    ...
    sessionStorage.setItem('handymanCategory', 'appliance-repair');
    router.push('/en/handyman/booking');
  };

  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="bg-gradient-to-r from-gray-600 to-gray-700 text-white py-12 px-4">
        <div className="container mx-auto max-w-7xl">
          <button onClick={() => router.push('/en/handyman')} className="text-white/80 hover:text-white mb-4">← Back</button>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🧰 Appliance Repair Services</h1>
          <p className="text-xl opacity-90">Professional appliance repair services in Dubai</p>
        </div>
      </div>
