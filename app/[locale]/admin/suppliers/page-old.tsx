...
import { Users, UserCheck, Star, MapPin, Phone, Mail, Plus, Package } from 'lucide-react';

export default async function AdminSuppliersPage({ params: { locale } }: { params: { locale: string } }) {
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
            ...
            <div className="text-sm opacity-90">Total Suppliers</div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          ...
          {items.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-gray-400 mb-6">Start by adding your first supplier</p>
              <Link
                href={`/${locale}/admin/suppliers/new`}
                  ...
                  {items.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <Link
                          href={`/${locale}/admin/suppliers/${item.id}`}
                          className="text-blue-600 hover:text-blue-900 mr-3"
                        >
                          View
                        </Link>
                        <Link
                          href={`/${locale}/admin/suppliers/${item.id}/edit`}
