...
import { Users, UserCheck, Star, MapPin, Phone, Mail, Plus, Dumbbell } from 'lucide-react';

export default async function AdminCoachesPage({ params: { locale } }: { params: { locale: string } }) {
  

  // Récupérer les providers (coaches)
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
            ...
            <div className="text-sm opacity-90">Total Coaches</div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
            ...
            <div className="text-sm opacity-90">Active Coaches</div>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
            ...
            <div className="text-sm opacity-90">Verified Coaches</div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-xl font-bold text-gray-900">Coaches List</h2>
          </div>
          
          {items.length === 0 ? (
            <div className="p-12 text-center">
              <Dumbbell className="w-16 h-16 text-gray-300 mx-auto mb-4" />
              <p className="text-gray-500 text-lg mb-2">No coaches found</p>
              <p className="text-gray-400 mb-6">Start by adding your first coache</p>
              <Link
                href={`/${locale}/admin/coaches/new`}
                  ...
                  {items.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <Link
                          href={`/${locale}/admin/coaches/${item.id}`}
                          className="text-blue-600 hover:text-blue-900 mr-3"
                        >
                          View
                        </Link>
                        <Link
                          href={`/${locale}/admin/coaches/${item.id}/edit`}
