...
import { Users, UserCheck, Star, MapPin, Phone, Mail, Plus, Plane } from 'lucide-react';

export default async function AdminActivitiesPage({ params: { locale } }: { params: { locale: string } }) {
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage activities and excursions</p>
          </div>
          <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
            ...
            <div className="text-sm opacity-90">Verified Activities</div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          ...
          {items.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-gray-400 mb-6">Start by adding your first activitie</p>
              <Link
                href={`/${locale}/admin/activities/new`}
                  ...
                  {items.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <Link
                          href={`/${locale}/admin/activities/${item.id}`}
                          className="text-blue-600 hover:text-blue-900 mr-3"
                        >
                          View
                        </Link>
                        <Link
                          href={`/${locale}/admin/activities/${item.id}/edit`}
