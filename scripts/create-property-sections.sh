...
# Script pour créer toutes les sections du PropertyForm

SECTIONS_DIR="app/[locale]/admin/properties/sections"

echo "🚀 Creating Property Form Sections..."
...
echo "✅ LocationSection created"

echo ""
echo "🎉 All sections created successfully!"
echo "📁 Location: $SECTIONS_DIR"
